...
export default function Donation() {
    ...
    const [page, setPage] = useState<Donation[]>([]);
    ...
    async function fetchDonations() {
        try {
            ...
            const res = await api.get(`/api/v1/donations?page=${currentPage}&size=${pageSize}`);
            ...
            <div className="w-full max-w-2xl bg-gray-100 p-6 rounded-lg shadow mb-6 text-left">
                {isLoading ? (
                    ...
                    <>
                        ...
                        <div>
                            {page.map((data) => (
                                <div key={data.donationId} className="text-xs sm:text-sm">
                                    <p
                                        onClick={() =>
                                            navigate(`/donation/${data.donationId}`, {
                                                state: {
